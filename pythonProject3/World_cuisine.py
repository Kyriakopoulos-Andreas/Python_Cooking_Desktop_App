...
class World_cuisine(customtkinter.CTk):
    def __init__(self, *args, **kwargs, ):
        super().__init__(*args, **kwargs)

        self.current_file_index = 0  # Initialize the current file index to 0
        self.file_paths = [str(file_path)+'//mediterranean.txt',
                           str(file_path)+'//mexican.txt',
                           str(file_path)+'//arabic.txt',
                           str(file_path)+'//chinese.txt',
                           str(file_path)+'//Thai.txt']
        ...
        self.information_logo = customtkinter.CTkLabel(self.out_frame, text="World Cuisines",
